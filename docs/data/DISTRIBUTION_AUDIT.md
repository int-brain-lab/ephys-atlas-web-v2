...
1. Inventory the current immutable local releases for all four representations:
   channels `2026_W32-d050-peak-val-raw-v2`, clusters
   `sha256-9b5e55215b306f26-d050-d048-v1`, Brain-Wide Map
   `legacy-v1-1d908bea-d050-linear-full-v1`, and volume
   `2026_W26-candidate-depth4-d050-linear-full-v1`.
