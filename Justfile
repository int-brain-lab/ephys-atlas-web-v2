...
data:
    {{uv-test}} python -m tools.development_bundle validate data/development-bundle-v2.json

# Run the descriptor-configured local catalog after complete available-graph validation.
dev:
    {{uv-test}} python -m tools.development_bundle run --cwd web data/development-bundle-v2.json -- npm run dev:real
...
validate-local-full url="http://localhost:5173/" output="../artifacts/local-full-browser-evidence":
    {{uv-test}} python -m tools.development_bundle run --cwd web data/development-bundle-v2.json -- node scripts/validate-local-full.mjs {{url}} {{output}}
