# Anatomy pack schema v1

`manifest.schema.json` defines an immutable `anatomy-pack-v1` release.
`slice-pack.schema.json` defines each JSON payload referenced by its pack
inventory. The normative scientific and semantic rules are documented in
